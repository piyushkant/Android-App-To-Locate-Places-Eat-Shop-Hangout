...
public class AuthUtils {
	...
	/** The Constant PREF_ACCOUNT_NAME. */
	public static final String PREF_ACCOUNT_NAME = "accountName";

	/** The Constant PREF_TOKEN. */
	public static final String PREF_TOKEN = "accessToken";

	// This scope lets you use the user id 'me' in API requests.
	// The Android AccountManager has experimental support for OAuth 2.0. You
	// simply need to
	// add oauth2:httpss://www.googleapis.com/auth/plus.me when setting the
	// AUTH_TOKEN_TYPE.
	// This isn't ideal because that string will be displayed in the
	// authorization dialog.
	// For this reason, you can use the human-readable alias assigned below
	// instead.
	// For more information, see
	// https://code.google.com/p/google-api-java-client/wiki/Android
	/** The Constant PLUS_ME_SCOPE. */
	...
	public static void refreshAuthToken(final Context context) {
		...
		if (null == account) {
			Intent accountListIntent = new Intent(context,
			...
			AccountManager.get(context).getAuthToken(account, PLUS_ME_SCOPE,
					true, cb, null);
		}
	}
}
