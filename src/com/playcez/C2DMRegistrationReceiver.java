...
/**
 * The Class C2DMRegistrationReceiver.
 */
public class C2DMRegistrationReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if ("com.google.android.c2dm.intent.REGISTRATION".equals(action)) {
			...
			uid = prefs.getString("uid", "nullllllll");
	...
	private void saveRegistrationId(Context context, String registrationId) {
		...
		edit.putString(Start_Menu.AUTH, registrationId);
		edit.commit();
	}
	 ...
	 * intent.putExtra("registration_id", registrationId); PendingIntent
	 * pendingIntent = PendingIntent.getActivity(context, 0, intent, 0);
	 * notification.setLatestEventInfo(context, "Registration",
	 * "Successfully registered", pendingIntent); notificationManager.notify(0,
	 * notification); }
	 */
	...
	public void sendRegistrationIdToServer(String deviceId,
		...
		HttpPost post = new HttpPost("https://playcez.com/api_updateC2DM.php");
		try {
			...
			Log.d("values of uid device_id and registration id", uid + " " + deviceId + " " + registrationId);
